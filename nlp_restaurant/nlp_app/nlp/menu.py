...
class Ingredients:
    ...
    CHICKEN = Ingredient(
        ...
        tokens={'цыпленок', 'цыпленком', 'цыпленка', 'курица', 'курицы', 'курицей',
    ...
    PINEAPPLE = Ingredient(
        ...
        tokens={'ананас', 'ананасами', 'ананасов', 'ананаса'}
    )
    PEPPER = Ingredient(
...
menu: set[Product] = {
    ...
    Pizza(name='Мясная',
          tokens={'мясная пицца', 'пицца мясная', 'пицца с мясом', 'пицца с мясо',
